...
<title>Show Markcard Table</title>
...
<tr>
	...
	<center><table ><tr>
	<td scope="col"><button><a href="updatemarkcard2.jsp?mid=<%=rs.getString(27) %>">Edit</a></button></td>
		<td scope="col"><button><a href="searchregistration.jsp?registration_no=<%=rs.getString(29) %>"">view</a></button></td></table></center>
