...
<div class="row">
  <div class="col"><div class="card" style="width: 35rem;">
   ...
   <div class="card-body">
    ...
    <a href="showstudentind.jsp"style="width:33rem;"  class="btn btn-primary">Show Student Details</a>
  </div>
</div></div>
<div class="row">
  <div class="col"><div class="card" style="width: 35rem;">
 ...
 <div class="card-body">
    <h5 class="card-title">Register Markcard</h5>

    <a href="markcard.jsp" style="width:33rem;" class="btn btn-primary">Register Markcard</a>
  </div>
</div></div>
 ...
 <div class="card-body">
    <h5 class="card-title">Result Calculate</h5>
   
    <a href="showmarkcardtable.jsp" style="width:33rem;" class="btn btn-primary">Result Calculate</a>
  </div>
</div></div>
 ...
 <div class="card-body">
    <h5 class="card-title">view Indivisual</h5>
    
    <a href="searchregistration.html" style="width:33rem;" class="btn btn-primary">view Indivisual</a>
  </div>
</div></div>
